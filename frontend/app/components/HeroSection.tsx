  ...
  return (
    <section className="max-w-7xl mx-auto px-5 md:px-8 pt-10 md:pt-16 pb-16 md:pb-24 grid md:grid-cols-2 gap-12 items-center relative">
      ...
      <div className="flex flex-col gap-5 md:gap-6 z-10 text-center md:text-left items-center md:items-start">
        ...
        {/* PERUBAHAN DI SINI: Tambahkan justify-center md:justify-start */}
        <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-3 sm:gap-4 mt-4 w-full md:w-auto">
          <button className="w-full sm:w-auto whitespace-nowrap shrink-0 bg-blue-600 text-white px-8 py-3.5 rounded-full font-semibold hover:bg-blue-700 transition-shadow shadow-lg shadow-blue-600/20">
            Buat Akun Sekarang
          </button>
          <button className="w-full sm:w-auto whitespace-nowrap shrink-0 bg-white text-slate-700 border border-slate-200 px-8 py-3.5 rounded-full font-semibold hover:bg-slate-50 transition-colors">
            Lihat Lowongan
          </button>
        </div>
      </div>
